...
// 记忆库（js/memory.js）：总开关键（"1" 开，默认关）、一次回复里最多几轮工具调用（设置项，默认 6，1–20）、
// 开场小抄存进消息的字符上限、允许的工具名
const MEMORY_KEY = "ember_memory";
const MEMORY_MAX_ROUNDS_KEY = "ember_memory_max_rounds";
const MEMORY_MAX_TOOL_ROUNDS = 6;
const MEMORY_MAX_TOOL_ROUNDS_MIN = 1;
const MEMORY_MAX_TOOL_ROUNDS_MAX = 20;
